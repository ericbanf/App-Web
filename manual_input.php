    ...
    <?
		...
		?>
        	<div class="fila_ingresos" id="<? echo $ingresos['entrada']; ?>">
                ...
                <div class="lista_ingresos_col_3">
                    <p class="btn_ingresar_entrada"><a href="https://www.meticketonline.com/registrarIngresos-web-manual.php?entrada=<? echo $entradas_disponibles['entrada'];?>&campania=<? echo $campania;?>" class="link_ingreso_entrada" target="_self">Ingresar</a></p>
                </div>
                <div style="clear:both;"></div>
            </div>
        	<!--
...
<script>
  ...
  $("#btn_volver").click(function(){
    window.location = "https://www.meticketonline.com/qr-scan3/reader.php?campania=<? echo $campania;?>&cantidadVendida=<? echo $cantidadVendida;?>"
  });
