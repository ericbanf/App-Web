...
<div style="background-image:url(images/Resonant+Burst.gif); background-position:center; background-repeat:no-repeat; background-size:cover; position:absolute; z-index:-1; width:100%; height:60%; opacity:.1;">
...
<div id="mensaje_resultado_ingreso">
    ...
    <?php if( $_GET['res'] == '5' ):   ?>
    	<p id="ingreso_error" class="mensaje_resultado_ingreso_aux">LA ENTRADA CORRESPONDE A OTRO EVENTO</p> 
    <?php endif ?>
</div>
