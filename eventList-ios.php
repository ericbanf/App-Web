...
//se comenta linea siguiente - e.k 13-12-20
$nombremail = $_COOKIE['usuarioControlLogueadoMail'];
//$nombremail = "ERICBANF@GMAIL.COM";
...
/*$sql="select vpuntosdeventas.*,campania.nombreCampania AS nombreCampania,campania.fechaEvento,campania.lugarEvento, puntoventa.tipo_usuario_control,campania.tipo AS tipoCampania
	...
	*/
	$sql = "SELECT vpuntosdeventas.*,campania.nombreCampania AS nombreCampania,campania.fechaEvento,campania.lugarEvento, puntoventa.tipo_usuario_control,campania.tipo AS tipoCampania from vpuntosdeventas,campania, puntoventa where vpuntosdeventas.usuario='$nombremail' and vpuntosdeventas.id_campania=campania.id_campania AND puntoventa.id_punto = vpuntosdeventas.id_punto AND vpuntosdeventas.estado LIKE 'ACTIVO'";
...
?>
        ...
        <div class="fila_eventos">
            ...
            <center><p><a href="https://www.meticketonline.com/qr-scan3/reader-ios.php?campania=<? echo $evento['id_campania']; ?>&cantidadVendida=<? echo $cantidad_vendidas;?>" class="link_evento"><? echo $evento['nombreCampania']; ?></a></p></center>
...
$sql="select vpuntosdeventas.*,campania.nombreCampania AS nombreCampania,campania.fechaEvento,campania.lugarEvento, puntoventa.tipo_usuario_control,campania.tipo AS tipoCampania
	...
	while ( $evento = mysqli_fetch_array($res) ){
		...
		$resultado_total_entradas = mysqli_query($consulta_total_entradas,$tienda);
